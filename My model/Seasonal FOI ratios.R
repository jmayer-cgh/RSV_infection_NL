...
getwd()
trajsim2 <- read.csv("Daycare with addition/add_DEzs_trajsim_ll.csv")
spring <- trajsim2$P
winter <- trajsim2$W
autumn <- trajsim2$A
summer <- trajsim2$M
...
write.csv(ratio_winter_autumn, "add_daycare_ratio_winter_autumn_ll.csv")
write.csv(ratio_winter_spring, "add__daycare_ratio_winter_spring_ll.csv")
write.csv(ratio_winter_summer, "add_daycare_ratio_winter_summer_ll.csv")
