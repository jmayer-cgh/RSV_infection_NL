...
samples_tuned <- monty_samples_thin(samples_tuned, burnin = 800)

matplot(samples_tuned$density, type = "l", lty = 1,
        xlab = "Sample", ylab = "Log posterior probability density")

dev.copy(jpeg,filename="/Users/juliamayer/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/LSTHM project/Extension/Plots/Checks/mcstate/Trace log post.png");
dev.off ()
```
...
dev.copy(jpeg,filename="/Users/juliamayer/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/LSTHM project/Extension/Plots/Checks/mcstate/Trace parameters.png");
dev.off ()
```
...
dev.copy(jpeg,filename="/Users/juliamayer/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/LSTHM project/Extension/Plots/Checks/mcstate/Uncertainty FOI.png");
dev.off ()

mcmc_intervals(draws_array_tuned, pars = "prop")
dev.copy(jpeg,filename="/Users/juliamayer/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/LSTHM project/Extension/Plots/Checks/mcstate/Uncertainty pi.png");
dev.off ()
```
...
dev.copy(jpeg,filename="/Users/juliamayer/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/LSTHM project/Extension/Plots/Checks/mcstate/Marginal posterior distributions.png");
dev.off ()
```
...
# Trajectories
trajectories <- dust_unpack_state(filter,
                                  samples_tuned$observations$trajectories)
sero_conv <- array(trajectories$R_all, c(19, 1000))
```
...
dev.copy(jpeg,filename="/Users/juliamayer/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/LSTHM project/Extension/Plots/Checks/mcstate/Model fit.png");
dev.off ()
```
