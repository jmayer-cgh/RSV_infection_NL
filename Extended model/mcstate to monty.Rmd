...
samples_tunned <- monty_samples_thin(samples_tuned, burnin = 800)

matplot(samples_tunned$density, type = "l", lty = 1,
        xlab = "Sample", ylab = "Log posterior probability density")

dev.copy(jpeg,filename="/Users/juliamayer/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/LSTHM project/Extension/Plots/Checks/mcstate/Trace log posterior season.png");
dev.off ()
```
...
```{r}
# Check trace
draws_tunned <- as_draws_df(samples_tunned)
mcmc_trace(draws_tunned, facet_args = list(ncol = 1, strip.position = "left"))
dev.copy(jpeg,filename="/Users/juliamayer/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/LSTHM project/Extension/Plots/Checks/mcstate/Trace parameters season.png");
dev.off ()
```

```{r}
# Summary
summarise_draws(draws_tunned)
```

```{r}
draws_array_tuned <- as_draws_array(draws_tunned)
# Posterior uncertainty intervals
# Plot them separetly because the values are very difference
mcmc_intervals(draws_array_tuned, pars = c("spring_comp", "summer_comp", "autumn_comp", "winter_comp"))
dev.copy(jpeg,filename="/Users/juliamayer/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/LSTHM project/Extension/Plots/Checks/mcstate/Uncertainty FOI season.png");
dev.off ()

mcmc_intervals(draws_array_tuned, pars = "prop")
dev.copy(jpeg,filename="/Users/juliamayer/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/LSTHM project/Extension/Plots/Checks/mcstate/Uncertainty pi season.png");
dev.off ()
```
...
dev.copy(jpeg,filename="/Users/juliamayer/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/LSTHM project/Extension/Plots/Checks/mcstate/Marginal posterior distributions season.png");
dev.off ()
```
...
# Trajectories
trajectories <- dust_unpack_state(filter,
                                  samples_tunned$observations$trajectories)
sero_conv <- array(trajectories$R_all, c(19, 1000))
```
...
dev.copy(jpeg,filename="/Users/juliamayer/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/LSTHM project/Extension/Plots/Checks/mcstate/Model fit season.png");
dev.off ()
```
...
dev.copy(jpeg,filename="/Users/juliamayer/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/LSTHM project/Extension/Plots/Checks/mcstate/Model fit season spring.png");
dev.off ()
```
...
dev.copy(jpeg,filename="/Users/juliamayer/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/LSTHM project/Extension/Plots/Checks/mcstate/Model fit season summer.png");
dev.off ()
```
