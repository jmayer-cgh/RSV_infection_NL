...
# save the trace
saveRDS(trace, "/Users/juliamayer/Library/CloudStorage/OneDrive-Charité-UniversitätsmedizinBerlin/LSTHM project/Extension/Odin model with BT and 1 M.rds")
```
...
theta3 <- c(spring_comp = 0.000078, summer_comp = 0.00060, autumn_comp = 0.00264, winter_comp = 0.00692)
...
theta4 <- c(spring_comp = 0.1, summer_comp = 0.1, autumn_comp = 0.1, winter_comp = 0.1)
...
theta5 <- c(spring_comp = 10, summer_comp = 10, autumn_comp = 10, winter_comp = 100)
...
for (i in 1:n) {
    # ... make some data
    theta <- c(spring_comp = runif(n = 1, min = 0, max = 0.01), 
              summer_comp = 0.00060, 
              autumn_comp = 0.00264, 
              winter_comp = 0.00692)
    log <- loglik(theta)
...
for (i in 1:n) {
    ...
    theta <- c(spring_comp = 0.00003478,
              summer_comp = runif(n = 1, min = 0, max = 0.001), 
              autumn_comp = 0.00264, 
              winter_comp = 0.00692)
    log <- loglik(theta)
    dat <- data.frame(spring_comp = theta[1], 
