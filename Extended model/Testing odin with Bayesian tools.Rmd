...
theta8 <- c(spring_comp = 10, summer_comp = 10, autumn_comp = 10, winter_comp = 10)

log8 <- loglik(theta8)

likelihood_values <- likelihood_values %>% add_row(spring_comp = theta8[1], 
                                                   summer_comp = theta8[2],
                                                   autumn_comp = theta8[3],
                                                   winter_comp = theta8[4],
                                                   loglikelihood = log8)
```
