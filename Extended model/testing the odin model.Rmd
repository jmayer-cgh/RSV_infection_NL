...
p_new <- list(dt = 1, 
              ...
              R_sp_ini = 0, R_sm_ini = 0, R_au_ini = 0, R_wt_ini = 0 #, beta = 0.4, gamma = 0.1, mu = 0.003
              )
...
# Add names
x_df_names <- c("M1_sp_ini", "M2_sp_ini", "S_sp_ini", "R_sp_ini",
                "M1_sm_ini", "M2_sm_ini", "S_sm_ini", "R_sm_ini",
                "M1_au_ini", "M2_au_ini", "S_au_ini", "R_au_ini",
                "M1_wt_ini", "M2_wt_ini", "S_wt_ini", "R_wt_ini")
...
time <- 1:n_times
x_transp <- cbind(time, x_transp)
```

```{r}
palette <- c("M1" = "#F2862C", "M2" = "#cc0044", "S" = "#8c8cd9", "R" = "#999966")
x_transp %>% ggplot(aes(x = time)) +
  geom_line(aes(y = M1_sp_ini, colour = "M1")) + 
  geom_line(aes(y = M2_sp_ini, colour = "M2")) + 
  geom_line(aes(y = S_sp_ini, colour = "S")) + 
  geom_line(aes(y = R_sp_ini, colour = "R")) + 
...
palette <- c("M1" = "#F2862C", "M2" = "#cc0044", "S" = "#8c8cd9", "R" = "#999966")
x_transp %>% ggplot(aes(x = time)) +
  geom_line(aes(y = M1_sm_ini, colour = "M1")) + 
  geom_line(aes(y = M2_sm_ini, colour = "M2")) + 
  geom_line(aes(y = S_sm_ini, colour = "S")) + 
  geom_line(aes(y = R_sm_ini, colour = "R")) + 
...
palette <- c("M1" = "#F2862C", "M2" = "#cc0044", "S" = "#8c8cd9", "R" = "#999966")
x_transp %>% ggplot(aes(x = time)) +
  geom_line(aes(y = M1_au_ini, colour = "M1")) + 
  geom_line(aes(y = M2_au_ini, colour = "M2")) + 
  geom_line(aes(y = S_au_ini, colour = "S")) + 
  geom_line(aes(y = R_au_ini, colour = "R")) + 
...
palette <- c("M1" = "#F2862C", "M2" = "#cc0044", "S" = "#8c8cd9", "R" = "#999966")
x_transp %>% ggplot(aes(x = time)) +
  geom_line(aes(y = M1_wt_ini, colour = "M1")) + 
  geom_line(aes(y = M2_wt_ini, colour = "M2")) + 
  geom_line(aes(y = S_wt_ini, colour = "S")) + 
  geom_line(aes(y = R_wt_ini, colour = "R")) + 
