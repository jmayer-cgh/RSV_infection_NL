...
spring_comp <- pmcmc_parameter("spring_comp", initial = 0.00001, max = 0.1, min = 0, prior = function(p)
  dunif(p, max = 0.1, min = 0))
summer_comp <- pmcmc_parameter("summer_comp", initial = 0.02002, max = 0.1, min = 0, prior = function(p)
  dunif(p, max = 0.1, min = 0))
autumn_comp <- pmcmc_parameter("autumn_comp", initial = 0.00003, max = 0.1, min = 0, prior = function(p)
  dunif(p, max = 0.1, min = 0))
winter_comp <- pmcmc_parameter("winter_comp", initial = 0.00004, max = 0.1, min = 0, prior = function(p)
  dunif(p, max = 0.1, min = 0))
...
```{r}
1 - coda::rejectionRate(mcmc2) # Is this better????
```
...
times <- c(0, model_data$age_days_start)
cols <- c(M1_sp = "#8c8cd9", M2_sp = "turquoise", S_sp = "#cc0044", R_sp = "#999966", R_all = "pink")
